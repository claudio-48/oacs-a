ad_library {
  ...
  @cvs-id $Id: 03-doc-procs.tcl,v 1.22.2.19 2026/01/19 10:24:28 gustafn Exp $
}
...
::nx::Object create ::xo::api {
  ...
  :public object method update_object_doc {scope obj doc_string} {
    ...
    set isNxClass [::xo::api scope_eval $scope \
                       ::nsf::directdispatch ::$obj \
                       ::nsf::methods::object::info::hastype ::nx::Class]
    set isNxObject [::xo::api scope_eval $scope \
                        ::nsf::directdispatch ::$obj \
                        ::nsf::methods::object::info::hastype ::nx::Object]
    if {$isNxClass} {
      #
      # nx classes
      #
